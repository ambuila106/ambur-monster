<template>
  <div class="home">
    ...
    <div @click="finalizeOrder()" class="finalize-order">
      ...
      <span class="fs-5">Realizar orden</span>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    finalizeOrder(){
      ...
      let text = "Me interesa la colaboración de Monstershake con Amburguer"
      window.location.href = 'https://wa.me/' + "57" + number + "?text=" + text
    }
  },
